...
//                 <input type="radio" id="vue" name="sabor" value="react" onChange={e => setSabor(e.target.value)} />
...
//                 <input type="radio" id="nextjs" name="sabor" value="nextjs" onChange={e => setSabor(e.target.value)} />
//                 <label htmlFor="nextjs" >Next JS</label>
//                 <input type="radio" id="polymer" name="sabor" value="polymer" onChange={e => setSabor(e.target.value)} />
    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit} >
                ...
                <label htmlFor="svelte" >Svelte</label>
                <input type="radio" id="nextjs" name="sabor" value="nextjs" onChange={handleChange} />
                <label htmlFor="nextjs" >Next JS</label>
                <input type="radio" id="polymer" name="sabor" value="polymer" onChange={handleChange} />
                <label htmlFor="polymer" >Polymer</label>
                <p>Elige tu lenguaje de programación favorito</p>
